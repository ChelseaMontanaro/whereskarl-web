...
export function MapPhonePortraitFogRail({
  ...
  return (
    <aside
      ...
      className="flex w-[3.75rem] flex-col gap-1 rounded-2xl border border-[rgb(150_175_200/0.18)] bg-[rgb(5_13_24/0.82)] px-1 py-1.5 shadow-[0_6px_12px_rgb(0_0_0/0.32)]"
    >
      <p className="text-center text-[0.5rem] font-extrabold uppercase leading-[0.625rem] tracking-[0.05em] text-white/90">
        Fog
        <br />
        Intensity
      </p>
        ...
        {RAIL_INTENSITIES.map((intensity) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-[3.25rem] flex-col items-center justify-center gap-0.5 rounded-xl border-[1.5px] px-0 py-1 transition-opacity motion-reduce:transition-none ${
                isActive
            ...
            >
              ...
              />
              <span
                className={`text-center text-[0.5625rem] font-semibold leading-[0.6875rem] ${
